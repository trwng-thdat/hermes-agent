...
def _(rid, params: dict) -> dict:
    # Multi-question clarify form. Same late-answer semantics as
    # clarify.respond above: a reconnect during the wait can pop the pending
    # entry while the form is still on screen, so a late submit must resolve
    # gracefully rather than 4009.
